...
module.exports = {
    ...
    const approvedIds = JSON.parse(fs.readFileSync(`${__dirname}approved_main.json`));
    const bypassIds = JSON.parse(fs.readFileSync(`${__dirname}bypass_id.json`));
